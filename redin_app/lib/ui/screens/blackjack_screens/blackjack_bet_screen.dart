...
class BlackJackBetScreen extends StatefulWidget {
  ...
  @override
  _BlackJackBetScreenState createState() => _BlackJackBetScreenState();
}
...
class _BlackJackBetScreenState extends State<BlackJackBetScreen> {
  ...
  void startGame(BuildContext context) {
    ...
    if (selectedBet > 0) {
      if (balanceProvider.balance >= selectedBet) {
        balanceProvider.subtractCoins(selectedBet);
        Navigator.push(
          context,
          AnimatedRoute(page: BlackJackScreen(initialBet: selectedBet)),
        );
      } else {
